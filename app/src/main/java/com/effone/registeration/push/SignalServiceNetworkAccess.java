...
import static com.effone.registeration.push.AccountManagerFactory.SIGNAL_CDN_URL;
import static com.effone.registeration.push.AccountManagerFactory.SIGNAL_URL;
...
public class SignalServiceNetworkAccess {
  ...
  public SignalServiceNetworkAccess(Context context) {
    ...
    this.uncensoredConfiguration = new SignalServiceConfiguration(new SignalServiceUrl[] {new SignalServiceUrl(SIGNAL_URL, new SignalServiceTrustStore(context))},
                                                                  new SignalCdnUrl[] {new SignalCdnUrl(SIGNAL_CDN_URL, new SignalServiceTrustStore(context))});
